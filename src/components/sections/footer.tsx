...
import { FaFacebook, FaTwitter, FaInstagram, FaYoutube, FaPinterest, FaLinkedin, FaTiktok } from "react-icons/fa";

export default function Footer() {
  return (
    <footer className="bg-[#333030] text-white py-12 px-4 sm:px-8 md:px-12 lg:px-36">
      <div className="max-w-7xl mx-auto grid gap-8 sm:gap-12 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 text-2xl">
            <a href="#" className="hover:text-[#1877F2]"><FaFacebook /></a>
            ...
            <a href="#" className="hover:text-[#000000]"><FaTiktok /></a>
            <a href="#" className="hover:text-[#0077B5]"><FaLinkedin /></a>
            <a href="#" className="hover:text-[#E60023]"><FaPinterest /></a>
          </div>
        </div>
      </div>
    </footer>
