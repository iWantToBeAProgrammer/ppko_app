...
export default function TumbuhKembangInfo() {
  ...
  const handleClick = (clickedId: number) => {
    setGambarArray(prevArray => {
      ...
      const clickedIndex = prevArray.findIndex(gambar => gambar.id === clickedId);
                ...
                <div className="space-y-6">
                    <div className="flex items-center">
                        <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center mr-4">
                            <img src="/assets/images/tumbuh-kembang/Shield Done.svg" className="w-6 h-6" alt="Shield Done" />
                        </div>
                        <span className="text-slate-700 text-lg font-medium">Menu MPASI Sehat</span>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="text-slate-700 text-lg font-medium">Pencegahan Stunting</span>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="text-slate-700 text-lg font-medium">Edukasi Stunting dan Gizi Seimbang</span>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="text-slate-700 text-lg font-medium">Dapatkan Panduan Gizi Anak dengan Mudah</span>
                    </div>
                </div>
            </div>
