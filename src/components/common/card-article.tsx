...
export default function CardArticle({
  ...
  return (
    <Wrapper>
      <Card className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm hover:shadow-lg transition-shadow duration-300 cursor-pointerp-4 py-0">
